class Sla < ApplicationRecord
  ...
  # Constants #
  SLA_ATTR = %w[service_level_agreement service_level_objective recovery_time_objective recovery_point_objective
                transactions_per_second response_time severity1 severity2 severity3 severity4
                severity1_restoration severity2_restoration severity3_restoration severity4_restoration]
