        ...
        bsls.each do |bsl|
          ...
          if bsl_sla_val && supplier_sla_val && risk_appetite_val
            ...
            supplier_data = {
              ...
              firm_impact_tolerance: risk_appetite_val,
              difference: risk_appetite_val - supplier.sla[sla_attr],
              total_number_of_critical_steps: supplier.critical_supplier_steps.count
            }
            breakdown_data["#{sla_attr}"][@match_tolerance > 0 ? "match_suppliers" : @meet_tolerance > 0 ? "meet_suppliers" : "suppliers" ] << supplier_data
          end
        end
      end
