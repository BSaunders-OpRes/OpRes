class Organisation::BusinessServiceLinesController < Organisation::BaseController
  ...
  def bsl_params
    ...
    params.require(:business_service_line).permit(:unit_id, :name, :description, :tier, product_ids: [], channel_ids: [], steps_attributes: %i[name description _destroy supplier_ids: []],
