...
class ChannelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create channel" do
    assert_difference('Channel.count') do
      post channels_url, params: { channel: { name: @channel.name, organisational_unit_id: @channel.organisational_unit_id } }
    end
  ...
  test "should update channel" do
    patch channel_url(@channel), params: { channel: { name: @channel.name, organisational_unit_id: @channel.organisational_unit_id } }
